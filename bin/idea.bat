...
SET _JRE_CANDIDATE=
IF "%JRE%" == "" IF EXIST "%APPDATA%\JetBrains\IdeaIC2023.3\idea64.exe.jdk" (
  SET /P _JRE_CANDIDATE=<"%APPDATA%\JetBrains\IdeaIC2023.3\idea64.exe.jdk"
)
IF "%JRE%" == "" (
...
IF "%VM_OPTIONS_FILE%" == "" (
  ...
  ) ELSE IF EXIST "%APPDATA%\JetBrains\IdeaIC2023.3\idea64.exe.vmoptions" (
    SET "USER_VM_OPTIONS_FILE=%APPDATA%\JetBrains\IdeaIC2023.3\idea64.exe.vmoptions"
  )
)
